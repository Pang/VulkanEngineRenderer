...
namespace graphicsEngine {
    ...
    void DeviceSetup::createInstance() {
    ...
    void DeviceSetup::createSurface() { window.createWindowSurface(instance, &surface_); }
    ...
    void DeviceSetup::populateDebugMessengerCreateInfo(
    ...
    std::vector<const char*> DeviceSetup::getRequiredExtensions() {
    ...
    void DeviceSetup::hasGflwRequiredInstanceExtensions() {
    ...
    VkFormat DeviceSetup::findSupportedFormat(
    ...
    VkCommandBuffer DeviceSetup::beginSingleTimeCommands() {
    ...
    void DeviceSetup::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
    ...
    void DeviceSetup::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    ...
    void DeviceSetup::copyBufferToImage(
    ...
    void DeviceSetup::createImageWithInfo(
